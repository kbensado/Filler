...
/*   Updated: 2016/12/21 00:00:44 by kbensado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "includes/ft_printf.h"

static char	*ft_getsconv_nextb(char *s, va_list *ap, t_e_print *env, int i)
{
	if (*s == 'c' && i == 0)
	{
		env->c = va_arg(*ap, int);
...
static char	*ft_getsconv_next(char *s, va_list *ap, t_e_print *env, int i)
{
...
static char	*ft_getsconv(char *s, va_list *ap, t_e_print *env, int i)
{
	void *p;
...
static char	*ft_getmodif(char *s, va_list *ap, t_e_print *env)
{
