...
/*   Updated: 2016/12/21 00:00:48 by kbensado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "includes/ft_printf.h"

static int	ft_is_str_next(t_e_print *env, int i)
{
	if (env->ispreci)
...
static int	ft_is_str(t_e_print *env, const char *s, int i)
{
...
static void	ft_is_nb_one_next(t_e_print *env)
{
...
static void	ft_is_nb_one(t_e_print *env)
{
...
int			ft_aff(va_list *ap, t_e_print *env, const char *s)
{
	int		i;
